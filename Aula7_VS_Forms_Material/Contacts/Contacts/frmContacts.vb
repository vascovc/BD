...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '' Change this line...
        CN = New SqlConnection("data source=VASCO-FIXO\TEW_SQLEXPRESS;integrated security=true;initial catalog=Northwind")
        'CN = New SqlConnection("data source=VASCO\TEW_SQLEXPRESS;integrated security=true;initial catalog=Northwind")
        CMD = New SqlCommand
        CMD.Connection = CN
        LoadMap()
